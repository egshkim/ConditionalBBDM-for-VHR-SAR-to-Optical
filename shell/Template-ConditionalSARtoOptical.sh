#train
python main.py --config configs/Template-ConditionalSARtoOptical.yaml --train --sample_at_start --save_top --sample_to_eval --gpu_ids 0
...
#test
python main.py --config configs/Template-ConditionalSARtoOptical.yaml --sample_to_eval --gpu_ids 0
